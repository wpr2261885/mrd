...
document.title=locale=="zh_CN"?"陈列管理":
  locale=="en_US"?"display management":
    locale=="es_SP"?"Gestión de Mostrar":
      locale=="zh_TW"?"陳列管理":"陈列管理";
...
import "./assets/plugins/jsTree/style.min.css"
