  ...
  export default {
    ...
    methods: {
      ...
      selectTag(index,index1=-1){
        ...
        console.log(this.selectInstance,this.selectTable)
      },
      //选择实体或区域切换
      ...
      handleCheckChange(data,checked,node){
        ...
        this.i++;
        console.log("iiiiiiiiiiiiiii:::",this.i)
        //单选
        if(this.i%2==0){
          if(checked){
        ...
        console.log("勾选",this.$refs.tree.getCheckedKeys())
      ...
      handleNodeClick(data) {
        ...
        this.$ajax.post(this.port+this.dev.treeByOrg,params).then((res)=>{
          ...
          if(this.selectInstance){
            ...
            this.i=0;
            console.log("这里输出的iiiiiiiiii:::",this.i)
      ...
      handleSelectionChange(val) {
        ...
        console.log("所选",this.multipleSelection)
      }
    }
  }
</script>
